...
**corinet** provides a lightweight pipeline for building **cor**relation **net**works to analyze gene co-expression in bulk RNA-seq data. Starting from a
...
See `corinet --help` and `corinet <subcommand> --help` for all available options.
